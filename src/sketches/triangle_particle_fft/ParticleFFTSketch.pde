...
public class ParticleFFTSketch extends FadecandySketch<Object> {
    ...
    ParticleFFTSketch(PApplet app, int bands, int size_px) {
        super(app, size_px);
    ...
    void draw(double t) {
        ...
        for (int i = 0; i < fftFilter.length; i += 3) {   
            ...
            center.rotate((float)(t * 1000 * spin + i * radiansPerBucket));
